...
const Testimonial = () => {
    const testimonials = [
        ...
        {  name: "Daniel", 
            ...
            image: assets.testimonial_image_1, 
            testimonial: "Great car rental service — the booking was quick, the car was clean, and pickup/drop-off were hassle-free.Pricing was fair with no surprises, and customer support was responsive and helpful." }
    ];
  return (
    <div className="py-28 px-6 md:px-16 lg:px-24 xl:px-44">
            ...
            <div className="grid grid-cols-1 sm:grid-col-2 lg:grid-cols-3 gap-8 mt-18">
                {testimonials.map((testimonial) => (
                    <div key={testimonial.id} className="bg-white p-6 rounded-xl shadow hover:-translate-y-1 transition-all rounded-full">
