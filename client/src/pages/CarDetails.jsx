    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12'>
          <div className='lg:col-span-1' >
            <img src={car.image} alt='' className='w-full h-auto md:max-h-100 object-cover rounded-xl 
            mb-6 shadow-md'/>
              <div className='space-y-6'>
                ...
                <div className='grid grid-cols-2 sm:grid-cols-4 gap-4'>
                  {[
                    ...
                    <div key={text} className='flex flex-col items-center bg-light p-4 rounded-lg text-sm'>
                ...
                <div>
                  ...
                  <ul className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
                    {
                      ["360 Camera" , "Bluetooth", "GPS", "Leather Seats"].map((item)=>(
                        <li key={item}>
          ...
          className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
            ...
            text-white rounded-xl cursor-pointer'>Book Now
            </button>
