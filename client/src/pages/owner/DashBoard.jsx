...
const DashBoard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-l'>
        ...
        <div className='flex flex-wrap items-start gap-2 mb-8 w-full'>
            {/* recent booking */}
            <div className='p-4 md:p-6 border border-borderColor rounded-md flex-1'>
                ...
                {data.recentBookings.map((booking, index)=>(
                    <div key={index} className='mt-4 flex items-center justify-between'>
                        <div className='flex items-center gap-2'>
                            ...
                            <div>
                                <p>{booking.car.brand} {booking.car.moedl}</p>
            ...
            {/* monthly revenue */}
            <div className='p-4 md:p-6 mb-6 border border-borderColor rounded-md w-full md:w-72 lg:w-80'>
